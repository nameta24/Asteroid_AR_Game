...
public class SetInitialRotationTowardsTarget : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        direction += new Vector3(Random.Range(-_randomOffset.x, _randomOffset.x), Random.Range(-_randomOffset.y, _randomOffset.y), Random.Range(-_randomOffset.z, _randomOffset.z));
